...
import { User, Package, MapPin, Calendar, Settings, LogOut, ChevronRight } from "lucide-react";
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-ambient-sm p-6">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-full bg-[#1F5D3B] flex items-center justify-center text-white font-serif text-xl font-bold">P</div>
                <div>
                  <p className="font-medium text-[#201B12]">Priya Sharma</p>
                  <p className="text-xs text-[#56615B]">priya@email.com</p>
                </div>
              </div>
              <nav className="space-y-1">
                ...
                <button className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-red-500 hover:bg-red-50 transition-colors mt-4">
            ...
            <div className="bg-white rounded-2xl shadow-ambient-sm p-6 mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-[#FEF2E3]">
                  ...
                  <p className="text-sm text-[#201B12]">Priya Sharma</p>
